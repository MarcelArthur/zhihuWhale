<jsp:useBean id="user" scope="session" class="nuonuo.userp.User"/>
    ...
    <nav class="navbar navbar-inverse" id="MM">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a href="index.jsp" class="navbar-brand">一鲸</a>
            </div>
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav">
                    <li><a href="${pageContext.request.contextPath}/homepagefill.jsp" >首页 <span class="sr-only">(current)</span></a></li>
                    <li>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="index.jsp">提醒 <span class="badge">10</span></a></li>
    ...
    <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="<c:url value="/QuestionAction"/>" id="question_sub" method="post">
                    <input type="hidden" name="method" value="Question_add"/>
                    <div class="form-group">
                        <div class="modal-body">
                            <p class="h3">写下你的问题</p>
                            <p class="h6">如果问题不足以描述请写问题描述</p>
                            <label for="que_title" class="sr-only">标题</label>
                            <input name="que_title" id="que_title"  class="form-control input-sm" type="text"/>
                            ...
                            <input type="text" class="form-control input-sm" id="que_tags" name="que_tags"/>
                        </div>
                    </div>
            ...
            <div class="panel panel-default ow-sidear-s">
                ...
                <div class="panel-body">
                    <ul class="ow-side-nav">
                        ...
                        <li class="ow-side-nav-li">
                            <a href="<c:url value="/adminpage.jsp"/> ">管理后台</a>
                        </li>
                    </ul>
                </div>
            </div>
